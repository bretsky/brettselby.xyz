...
weapons = ["Glock-18",
		   ...
		   "M9 Bayonet",
		   "Shadow Daggers"]
print("Setup done in", time()-start)
...
# print('\n' +'\n'.join((', '.join((str(x) for x in item)) for item in weapon_count)))
print("Web loading and random generation completed in", time()-start)
